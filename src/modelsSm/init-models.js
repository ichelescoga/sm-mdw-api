...
function initModels(sequelize) {
  ...
  MDW_Order.belongsTo(MDW_Order_Detail, { as: "id_detail_client_MDW_Order_Detail", foreignKey: "id_detail_client"});
  MDW_Order_Detail.hasMany(MDW_Order, { as: "MDW_Orders", foreignKey: "id_detail_client"});
